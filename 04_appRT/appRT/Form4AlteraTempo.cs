...
namespace appRT
{
    public partial class Form4AlteraTempos : Form
    {
        ...
        public Form4AlteraTempos()
        {
            ...
            ssql = "SELECT DISTINCT CONVERT(CHAR(4), YEAR(data)) as 'Ano' FROM T_registo_de_tempos ORDER BY 'Ano';";
            InitComboBox(cmb_ano, ssql, "Ano", "Ano", "-- Mostrar Todos --");

            ssql = "SELECT DISTINCT FORMAT(data, 'MMMM', 'pt-PT') as 'mes', MONTH(data) as 'num_mes' FROM T_registo_de_tempos ORDER BY 'num_mes'";
